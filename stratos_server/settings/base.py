...
ROOT_URLCONF = 'stratos_server.urls'
...
WSGI_APPLICATION = 'stratos_server.wsgi.application'
...
CELERY_BEAT_SCHEDULE = {
    ...
    'sync-malwarebazaar-daily': {
        'task': 'threat_intel.tasks.sync_malwarebazaar_task',
        'schedule': crontab(hour=2, minute=0),
    },
    'sync-urlhaus-daily': {
        'task': 'threat_intel.tasks.sync_urlhaus_task',
        'schedule': crontab(hour=2, minute=30),
    },
}

# Scoring thresholds
CLEAN_THRESHOLD = int(os.environ.get('CLEAN_THRESHOLD', 25))
MALICIOUS_THRESHOLD = int(os.environ.get('MALICIOUS_THRESHOLD', 70))
